...
| Phase | Weeks | Focus |
|---|---|---|
| Phase 1 | 1–3 | Folder structure, all Mongoose models, Express setup, Auth API, React scaffold, Auth UI |
| Phase 2 | 4–6 | Search API (Gemini + cache + DB match), Operator/Hotel seeding, Search + Hotel UI |
| Phase 3 | 7–9 | Booking engine, Payment simulation, QR + e-ticket, Email confirmation |
| Phase 4 | 10–12 | Partner portal, Admin dashboard, Deployment |
